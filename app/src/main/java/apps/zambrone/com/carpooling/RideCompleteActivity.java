...
public class RideCompleteActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Ride Completed");
       ...
       // ButtonEffects.buttonEffect(findViewById(R.id.btnFirstSignIn));
        findViewById(R.id.activity_route_btn_save_route).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(RideCompleteActivity.this,PromotionListActivity.class);
