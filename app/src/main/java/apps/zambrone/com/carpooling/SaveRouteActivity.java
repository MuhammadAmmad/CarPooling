...
public class SaveRouteActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Save Route");
        ...
        findViewById(R.id.activity_route_btn_save_route).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SaveRouteActivity.this, AddYourLocationsActivity.class);
